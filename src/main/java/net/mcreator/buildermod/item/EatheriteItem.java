...
public class EatheriteItem extends BuildermodModElements.ModElement {
	@ObjectHolder("buildermod:eatherite")
	public static final Item block = null;
	public EatheriteItem(BuildermodModElements instance) {
		super(instance, 6);
	}
