...
package net.mcreator.buildermod.world.dimension;
...
import net.mcreator.buildermod.item.EAtherItem;
...
public class EAtherDimension extends BuildermodModElements.ModElement {
	@ObjectHolder("buildermod:e_ather_portal")
	public static final CustomPortalBlock portal = null;
	public EAtherDimension(BuildermodModElements instance) {
		super(instance, 1);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("buildermod:e_ather"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("e_ather_portal", Vector3i::compareTo, 300);
	public static class POIRegisterHandler {
		...
		public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
			poi = new PointOfInterestType("e_ather_portal", Sets.newHashSet(ImmutableSet.copyOf(portal.getStateContainer().getValidStates())), 0, 1)
					.setRegistryName("e_ather_portal");
	...
	public void initElements() {
		...
		elements.items.add(() -> new EAtherItem().setRegistryName("e_ather"));
	}
		...
		public void animateTick(BlockState state, World world, BlockPos pos, Random random) {
			...
			if (random.nextInt(110) == 0)
				world.playSound(pos.getX() + 0.5, pos.getY() + 0.5, pos.getZ() + 0.5,
						(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation(("ambient.nether_wastes.loop"))),
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("buildermod:e_ather"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos, RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("buildermod:e_ather")));
				} else {
					entity.func_242279_ag();
