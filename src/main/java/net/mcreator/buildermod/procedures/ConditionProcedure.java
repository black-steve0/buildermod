...
public class ConditionProcedure extends BuildermodModElements.ModElement {
	public ConditionProcedure(BuildermodModElements instance) {
		super(instance, 64);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				BuildermodMod.LOGGER.warn("Failed to load dependency entity for procedure Condition!");
			return;
		}
		...
		if ((((new Object() {
		...
		}.getItemStack((int) (1))).getItem()) && (0 == (wait)))) {
			wait = (double) 1;
			...
			}.getItemStack((int) (2))).getItem()) || (!((new Object() {
				public ItemStack getItemStack(int sltid) {
					Entity _ent = entity;
					if (_ent instanceof ServerPlayerEntity) {
						Container _current = ((ServerPlayerEntity) _ent).openContainer;
